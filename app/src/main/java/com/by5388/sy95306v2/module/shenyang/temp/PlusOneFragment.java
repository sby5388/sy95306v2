package com.by5388.sy95306v2.module.shenyang.temp;
...
import com.by5388.sy95306v2.t201906.IQueryThread;
...
public class PlusOneFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        testButton = (Button) view.findViewById(R.id.test);
    ...
    private void test() {
        ...
        final String to = "GZQ";
        final String type = "1";
        mIQueryThread.queryTicketPrices(date, from, to, type);
    }
