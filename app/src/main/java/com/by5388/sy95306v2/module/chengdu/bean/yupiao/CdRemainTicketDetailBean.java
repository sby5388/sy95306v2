...
public class CdRemainTicketDetailBean implements IRemainingTicket {
    ...
    public String getRz() {
        ...
        if (!rz_num.startsWith(EMPTY)) {
            stringBuilder.append(rz_num);
        }
        if (!zy_num.startsWith(EMPTY)) {
            stringBuilder.append(zy_num);
        }
    ...
    public String getYz() {
        StringBuilder stringBuilder = new StringBuilder();
        if (!ze_num.startsWith(EMPTY)) {
            stringBuilder.append(ze_num);
        }
        if (!yz_num.startsWith(EMPTY)) {
            stringBuilder.append(yz_num);
        }
        return stringBuilder.toString().replaceAll("[^0-9]", "");
    }
