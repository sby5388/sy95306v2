...
public class DataBean {
    /**
     * startTrainDate : 20190106
     * trainNo : 6j000D74250F
     * startStationTelephoneCode : RVQ
     * startStationName : 饶平
     * startStartTime : 15:24
     * endStationTelephoneCode : IOQ
     * endStationName : 深圳北
     * endArriveTime : 17:47
     * trainTypeCode : 3
     * trainTypeName : 局管
     ...
     * displayStationNo : 0
     * stationName : 饶平
     * stationTelephoneCode : RVQ
     * stationTrainCode : D7425
     * bureauCode : Q
     * arriveDayDiff : 0
     * arriveTime : ----
     * updateArriveTime : ----
     ...
     * stopDate : 2019-01-20 00:00:00
     * stationTrainDate : 20190106
     * cityCode : ----
     * sameCityCode : 1515
     * stopoverTime : 0
     * runningTime : --
    ...
    private String endStationTelephoneCode;
    @SerializedName("end_station_name")
    private String endStationName;
    @SerializedName("end_arrive_time")
    ...
    @SerializedName("start_day_diff")
    private String startDayDiff;
    @SerializedName("start_date")
    private String startDate;
    @SerializedName("stop_date")
    private String stopDate;
    @SerializedName("station_train_date")
    private String stationTrainDate;
    @SerializedName("city_code")
    private String cityCode;
    @SerializedName("same_city_code")
