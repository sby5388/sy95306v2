package com.by5388.sy95306v2.activity.sy.list;
...
import com.by5388.sy95306v2.activity.sy.list.presenter.ITrainListPresenter;
import com.by5388.sy95306v2.activity.sy.list.presenter.TrainListPresenter;
...
public class TrainNumberListActivity extends BaseActivity implements ITrainListView, UpdateFilterDataCallBack {
    ...
    protected void initData() {
        ...
        TrainOnClickListener listener = (view, position) -> {
            ...
            startActivity(TrainDetailActivity.startActivity(this, selectedDate, number.getSTCODE()));
        };
