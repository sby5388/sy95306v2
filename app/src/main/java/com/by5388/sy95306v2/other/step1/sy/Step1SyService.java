...
public interface Step1SyService {
     ...
     */
    @GET(QUERY_FIRST)
    Call<List<TrainNumber>> getTrainNumberByP2P(@Query(TRAIN_DATE) int date,
     ...
     */
    @GET(QUERY_SECOND)
    Call<List<TrainDetail>> getTrainByTrainCode(@Query(TRAIN_DATE) int date,
