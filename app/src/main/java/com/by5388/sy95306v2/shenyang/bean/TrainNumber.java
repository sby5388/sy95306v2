package com.by5388.sy95306v2.shenyang.bean;
...
public class TrainNumber {
     ...
     * 6:普客    TCCODE:3 普快
     */
    private static final String[] TCCODE_CODE = {
            "8", "D", "1", "2", "0", "3"
    };
    private static final String[] TCCODE_NAME = {
            "高速", "动车", "直特", "特快", "快速", "普快"
    };
    ...
    public String getDescription() {
        return getTrainNumberClass() + " " + isACTrain();
    }

    private String getTrainNumberClass() {
        for (int i = 0; i < TCCODE_CODE.length; i++) {
            if (TCCODE_CODE[i].equals(TCCODE)) {
                return TCCODE_NAME[i];
            }
        }
        return TCCODE;
    }
